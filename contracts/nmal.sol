...
contract NLGmal {
    ...
    function addressToNlgmal(address _address) public pure returns (string memory) {
        uint256 decimalAddress = uint256(uint160(_address));
        return decimalToNlgmal(decimalAddress);
    }
}
